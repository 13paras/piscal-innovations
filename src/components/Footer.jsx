...
const Footer = () => {
  ...
  return (
    <>
      ...
      <hr className='h-1 w-full border-0 bg-gradient-to-r from-emerald-500 to-lime-600' />
      <div>
        <Wrapper>
          <footer className='bg-white'>
            <div className='mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24'>
              <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
                <div>
                  <img src={logo} alt='' className='w-20 sm:w-24 rounded-full' />
                ...
                <div className='grid w-full grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2'>
                  <div className='w-full'>
                    ...
                    <nav className='space-y-4 text-zinc-700'>
                      ...
                      <li className='cursor-pointer transition-all duration-150 ease-in-out hover:text-green'>
                        About Us
                      </li>
                      <li className='cursor-pointer transition-all duration-150 ease-in-out hover:text-green'>
                        Services
